document.addEventListener("DOMContentLoaded", function() {
    // Извикване на функцията при клик на бутон
    document.getElementById('fetchDataButton').addEventListener('click', function() {
        fetchDataFromTable();
    });

    // Извикване на функцията за взимане на данни от таблицата
    fetchDataFromTable();
});

function fetchDataFromTable() {
    // Fetch заявка за данни
    fetch('https://192.168.1.3:2662/getInfo', {
        method: 'GET',
        headers: {
        ...
        .then(data => {
            // Обработка на данните и визуализацията им
